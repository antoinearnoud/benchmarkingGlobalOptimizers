...
IMPLICIT NONE
    ...
    REAL(DP), parameter :: p_tolf_amoeba= 1.0d-8 ! Amoeba variables -- LS changed from 10e-8 to other values
    INTEGER(I4B), parameter :: p_itmax_amoeba=1000 ! Amoeba variables -- NOT USED
    REAL(DP), PARAMETER :: rhoend_dfls = 1.0D-8 ! DFLS rho end variable 
